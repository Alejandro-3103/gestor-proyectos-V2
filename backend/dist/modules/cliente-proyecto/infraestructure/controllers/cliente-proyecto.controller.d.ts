...
export declare class ClienteProyectoController {
    ...
    findAll(): Promise<import("../../domain/entities/cliente-proyecto.entity").ClienteProyecto[]>;
    findOne(id: string): Promise<import("../../domain/entities/cliente-proyecto.entity").ClienteProyecto>;
    getClientesForProyecto(proyectoId: string): Promise<import("../../domain/entities/cliente-proyecto.entity").ClienteProyecto[]>;
